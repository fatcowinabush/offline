...
export async function onRequest(context) {
  ...
  const metatitle = "TAZYOURLIFEISOVER.COM"
  const metadescription = "This is where a description would normally be, but we really dont have time for this nonsense."
